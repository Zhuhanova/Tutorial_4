...
// Check if changes are visible in customer reservations
        System.out.println("\nReservations for customer " + customer1.getFirstName() + " " + customer1.getLastName() + " after price change:");customer1.displayReservations();
        System.out.println("\nReservations for customer " + customer2.getFirstName() + " " + customer2.getLastName() + " after price change:");
